...
struct Memo: Identifiable, Codable{
    ...
    var workerSaveStatus: SaveStaus = .unsaved
    var aiNote: String?
    var modelType: AIModelType
    
    init(id: UUID=UUID(), title: String, date: Date? = nil, transcript: String? = nil, noteType: NoteType? = nil, workerSaveStatus: SaveStaus = .unsaved, aiNote: String? = nil, modelType: AIModelType = .gpt4) {
        self.id = id
        self.title = title
        self.date = Date()
        self.transcript = transcript
        self.noteType = noteType
        self.workerSaveStatus = workerSaveStatus
        self.aiNote = aiNote
